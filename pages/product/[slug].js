    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <Image
            alt="ecommerce"
            className="lg:w-1/2 w-full lg:h-auto h-72 object-start rounded"
            src="/hoodies.jpg"
            width={400}
            height={320}
          />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              <span className="title-font font-medium text-2xl text-gray-900 mx-6">
                ₹458.00
              </span>
              <input
                className="mx-3 rounded-3xl text-sm border-2 border-pink-800 px-2"
